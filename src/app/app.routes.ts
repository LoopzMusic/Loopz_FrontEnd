...
export const routes: Routes = [
  ...
  { path: 'admin/produtos', component: CadastrarProduto, canActivate: [perfilGuardGuard] },
  ...
  { path: 'admin/empresas', component: CadastrarEmpresa, canActivate: [perfilGuardGuard] },
